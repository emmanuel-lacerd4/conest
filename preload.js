...
contextBridge.exposeInMainWorld('api', {
    ...
    buscarProdutoPorFornecedor: (nomeFornecedor) => ipcRenderer.send('search-product-by-supplier', nomeFornecedor),
    ...
    renderizarProdutoPorFornecedor: (dadosProduto) => ipcRenderer.on('product-data-supplier', dadosProduto),
